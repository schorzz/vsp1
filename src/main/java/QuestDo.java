...
import teemp.Join_AdventureGuild;
...
public class QuestDo {
    ...
    public void chooseQuest(String id){
        Resty r = new Resty();
       ...
       // System.out.println("Questnummer:");
        ...
        try {
            // Questdaten sammeln
            //-------------------------------------------------------------------------
            String chosenQuest = r.text(quests + "/" + id).toString();
    ...
    public TextResource visitQuestLocation(String host, String resource, String questDeliveryDestination) {
        ...
        try {
           ...
           // String token = guild.login("http://blackboard:5000/login");
            ...
            //nur damit kein fehler kommt. der token muss noch geholt werden..
            String token="";
